...
const result = spawnSync(
  process.execPath,
  ["dist-lease-log-pump/lease-log-pump.mjs"],
  {
    encoding: "utf8",
    env: {
      PATH: path,
...
if (
  ...
  throw new Error(
    "packaged lease-log pump did not reach its expected missing-environment guard"
  );
}
process.stdout.write("lease-log pump packaged entry loaded successfully\n");
