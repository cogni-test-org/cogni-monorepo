 ...
 * Purpose: Client sidebar shell for admin pages — mirrors `(app)/layout.tsx` so admin/app nav stays visually coherent.
 ...
 * Side-effects: none
 * Links: src/app/(admin)/layout.tsx, src/features/layout
 * @public
 */
