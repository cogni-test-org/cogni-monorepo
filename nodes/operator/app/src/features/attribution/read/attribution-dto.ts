...
/**
 * Module: `@features/attribution/read/attribution-dto`
 ...
 * Note: Canonical home is the feature layer so feature-layer readers (epoch-views) and app-layer
 *   routes can both import these pure mappers without a features→app dependency. The historical
 *   `@/app/api/v1/public/attribution/_lib/attribution-dto` path re-exports from here.
 * @internal
 */
