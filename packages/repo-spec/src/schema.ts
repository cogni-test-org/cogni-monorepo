 ...
 * Runtime assembly also exports HOST/HOSTNAME/PORT, while the image remains
 * responsible for honoring that process contract.
 */
 ...
 * other services share the workload network privately by service-name DNS.
 */
